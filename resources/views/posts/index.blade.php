<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8s">
                        ...
                        <textarea name="message" placeholder="{{__('What\'s do you think?')}}"
                              class="block w-full rounded-md bg-white shadow-sm
                                    @error('message') border-red-600 @enderror
                                     ...
                                     dark:bg-gray-800
                                      dark:text-white
                                     dark:focus:border-blue-300 dark:focus:ring-blue-200 dark:focus:ring-opacity-50"
                        ></textarea>
            ...
            {{-- Aquí empeiza la lista de publicaciones --}}
            @foreach ($posts as $post)
                <div class="mt-6 bg-white dark:bg-gray-800 shadow-sm rounded-lg divide-y dark:divide-gray-900">
                    <div class="p-6 flex space-x-2"> 
                        <svg class="h-6 w-6 dark:text-gray-400 scale-x-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
